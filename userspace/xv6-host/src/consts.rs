...
pub(crate) const PROC_CONSOLE_READ: u8 = 7;
...
pub(crate) use xv6_abi::{
    ...
    FS_OP_MKDIR, FS_OP_MKNOD, FS_OP_OPEN, FS_OP_READ, FS_OP_READDIR, FS_OP_RETAIN, FS_OP_UNLINK,
    FS_OP_WRITE, MAX_EXEC_ARG_LEN, MAX_EXEC_ARGS, MAX_FD, MAX_FILE_BYTES, MAX_OPEN_FILES,
    MAX_PIPES, O_CREATE, O_RDWR, O_TRUNC, O_WRONLY, PIPE_BUF, ROOT_INO, SYS_CHDIR, SYS_CLOSE,
    ...
    VIRTIO0_IRQ, XV6_ABI_VERSION, XV6_DISK_COMPLETION_BADGE, XV6_DISK_COMPLETION_NTFN_CPTR,
    XV6_DISK_COMPLETION_RING_VADDR, XV6_DISK_ENDPOINT_CPTR, XV6_DISK_IRQ_BADGE,
    XV6_DISK_IRQ_HANDLER_CPTR, XV6_DISK_IRQ_NTFN_CPTR, XV6_DISK_SERVER_BADGE,
    XV6_DISK_SHARED_BUFFER_VADDR, XV6_EBUSY, XV6_FS_SERVER_BADGE, XV6_HOST_TO_FS_PROTOCOL,
    XV6_MAX_FILE_WRITE, XV6_OK, XV6_SERVER_CNODE_CPTR, XV6_SERVICE_ENDPOINT_CPTR,
