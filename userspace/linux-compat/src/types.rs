...
impl SyscallResult {
    pub(crate) fn err(errno: i32) -> Self {
        Self::Reply(-(errno as i64))
    }
}
...
pub(crate) struct TaskStruct {
    ...
    pub(crate) wait_pid: i64,
    pub(crate) wait_options: u32,
    ...
    pub(crate) elf_phdr: u64,
    pub(crate) elf_phent: u16,
    pub(crate) elf_phnum: u16,
    pub(crate) exec_path: [u8; MAX_PATH_BYTES],
    pub(crate) exec_path_len: usize,
}
