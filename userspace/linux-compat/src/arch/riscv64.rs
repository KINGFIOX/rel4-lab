...
const UNKNOWN_SYSCALL_A3: usize = 6;
const UNKNOWN_SYSCALL_A4: usize = 7;
const UNKNOWN_SYSCALL_A5: usize = 8;
...
pub(crate) fn syscall_arg(mrs: &[u64; 64], index: usize) -> u64 {
    match index {
        ...
        3 => mrs[UNKNOWN_SYSCALL_A3],
        4 => mrs[UNKNOWN_SYSCALL_A4],
        5 => mrs[UNKNOWN_SYSCALL_A5],
        _ => 0,
    }
}
