...
fn root_cnode_size_bits() -> usize {
    match env::var("KERNEL_ROOT_CNODE_SIZE_BITS") {
        Ok(value) if value.trim() == "16" => 16,
        _ => 13,
    }
}
