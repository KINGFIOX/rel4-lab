...
pub const CSR_TLBRBADV: usize = 0x089;
pub const CSR_TLBRERA: usize = 0x08a;
pub const CSR_TLBRSAVE: usize = 0x08b;
pub const CSR_TLBRELO0: usize = 0x08c;
pub const CSR_TLBRELO1: usize = 0x08d;
pub const CSR_TLBREHI: usize = 0x08e;
pub const CSR_TLBRPRMD: usize = 0x08f;
...
ro_csr!(tlbrbadv, CSR_TLBRBADV);
rw_csr!(tlbrera, set_tlbrera, CSR_TLBRERA);
rw_csr!(tlbrsave, set_tlbrsave, CSR_TLBRSAVE);
rw_csr!(tlbrelo0, set_tlbrelo0, CSR_TLBRELO0);
rw_csr!(tlbrelo1, set_tlbrelo1, CSR_TLBRELO1);
rw_csr!(tlbrehi, set_tlbrehi, CSR_TLBREHI);
rw_csr!(tlbrprmd, set_tlbrprmd, CSR_TLBRPRMD);
