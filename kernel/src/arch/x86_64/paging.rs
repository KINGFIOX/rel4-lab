...
pub const PTE_KERNEL_RWX: u64 = PTE_PRESENT | PTE_W | PTE_G;
pub const PTE_USER_RW: u64 = PTE_PRESENT | PTE_W | PTE_U | PTE_NX;
pub const PTE_USER_RX: u64 = PTE_PRESENT | PTE_U;
pub const PTE_USER_RWX: u64 = PTE_PRESENT | PTE_W | PTE_U;
...
impl Pte {
    ...
    pub const fn is_leaf(self) -> bool {
        (self.0 & PTE_PRESENT) != 0 && (self.0 & PTE_PS) != 0
    }

    #[inline]
    pub const fn ppn(self) -> u64 {
        (self.0 & PTE_ADDR_MASK) >> PAGE_SHIFT
    }
